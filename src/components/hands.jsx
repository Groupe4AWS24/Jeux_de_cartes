  ...
  const Section = () => {
    ...
    return (
      <div className="flex-container">
        <div className="divleft divs">{length >= 2 && mains[1]}</div>
        <div className="divmid divs">
          <div className="divrowtop">{length >= 3 && mains[2]}</div>
          <div className="divrowmid">
            <div className="draw">{<BackCard key={0} />}</div>
          ...
          <div className="divrowbottom">{length >= 1 && mains[0]}</div>
        </div>
        <div className="divright divs">{length >= 4 && mains[3]}</div>
      </div>
    );
  };
